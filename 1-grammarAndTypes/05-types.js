...
//boolean can represent: true/false, yes/Node, on/off, 0/1
...
// Strings
//  A string is any value with quotes; JS spits out the value within the quotes
...
let third = 1050 + '100'; //Coersion - value converted to string since # and '' used in same line
console.log(third);
...
key--value pair is seaprated with a comma
*/
let hulk = {
    color: 'green',
    age: 42,
...
// Arrays
/* 
Arrays store multiple values in an orderd way. They, too, hold mulitple data types.

Denoted by []
Has value ('blue', 'green', 'yellow'), separated by commas
*/

let stepsToBrushTeeth = ['uncap toothpaste', 'squeeze toothpaste','rinse brush','brush','clean toothbrush'];
