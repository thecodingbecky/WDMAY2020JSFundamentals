...
console.log(sentence('Becky', 'Francis'));
console.log(sentence('Darron', 'Francis'));
let superImportantSentence = sentence('Gabriel', 'Francis');
console.log(superImportantSentence);

// let's build a function that takes a complex type--an array in this case, anc console.logs each
